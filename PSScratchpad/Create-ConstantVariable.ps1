...
New-Variable -Name ROFeigenbaumConst -Value 46692 -Option ReadOnly
...
Set-Variable -Name ROFeigenbaumConst -Value 46692 -Force
Write-Host $ROFeigenbaumConst
...
New-Variable -Name CONFeigenbaumConst -Value 46692 -Option Constant
...
Set-Variable -Name CONFeigenbaumConst -Value 46692 -Force
Write-Host $CONFeigenbaumConst
